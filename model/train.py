...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--transformer_model", default="bart-large")
    parser.add_argument("--tokens_per_batch", type=int, default=900)
    parser.add_argument("--squad_head", action="store_true")
    parser.add_argument("--use_pmask", action="store_true")
    parser.add_argument("--add_glosses_noise", action="store_true", default=True)
    ...
    parser.add_argument("--learning_rate", default=0.000002, type=float)
...
def train(args: argparse.Namespace):
    ...
    trainer = pl.Trainer(
        ...
        weights_save_path=f"results/{args.run_name}",
    )
    ...
    if args.use_special_tokens:
        tokenizer.save(f"results/{args.run_name}/tokenizer_with_st")
